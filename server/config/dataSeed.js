module.exports = [
  ...
  },
  {
    ...
    years_exp: 1,
    status: 'pending',
    date_applied: '2018-06-20T11:55:42Z',
    reviewed: false,
    description: 'Highly-motivated and self-starting software developer with an engineering background and a student-athlete mindset. Developed back-end modules and APIs in a professional environment. Thriving to improve on full-stack development skills and evolve as a versatile software developer. Ready to offer my potential and endless ambition to a new team project.',
  },
];
